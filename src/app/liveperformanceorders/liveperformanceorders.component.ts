...
@Component({
  ...
  templateUrl: './liveperformanceorders.component.html',
  styleUrls: ['./liveperformanceorders.component.scss'],
})
export class LiveperformanceordersComponent implements OnInit {
